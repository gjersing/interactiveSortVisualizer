#quick sort implementation for interactiveSorting visualizer
#quick sort is a recursive algorithm that calls itself to sort partitions

#Uses last element as pivot and first element as border. Ptr set to first element.
